    ...
    <center >
      <br><br><br><br>
       <!--  <div style="width: 85vw;"> -->
        ...
        <? 
        //echo "SELECT *,tbl_from_data_row.id ,tbl_form_data_filled.id as filled_data_id FROM tbl_from_data_row LEFT JOIN tbl_form_data_filled ON   tbl_form_data_filled.row_id = tbl_from_data_row.id Where tbl_from_data_row.data_heading_id='".$row['id']."'AND tbl_from_data_row.main_id='$main'and tbl_from_data_row.is_deleted='0'";
            ...
            <tbody>
              ...
              <tr>
                ...
                <?
                 ...
                 <option value="<?=$obj->ref_docs_select;?>"><?=$obj->ref_docs_select;?></option>
                  <?
                  }
                 ?>
              ...
              <tr>
                <td colspan="2" style="text-align: center;padding-top: 10;">
                  ...
                  <center><input type="button"  style="border-radius: 8px;background: #d82731;border: none;
    color: white;padding: 15px 32px;text-align: center;text-decoration: none;display: inline-block;font-size: 16px;"  id="update_heading_rows" name="update_heading_rows" value="Save"></center>
                </td>
              </tr>
               </tbody>
            </table>
